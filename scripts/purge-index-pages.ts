...
const TARGETS = [
  ...
  {
    name: "practical-classics-bookazines",
    host: "practicalclassics.co.uk",
    path: "/magazine/offers/bookazines",
    example: "https://www.practicalclassics.co.uk/magazine/offers/bookazines",
    sourceId: "auto_021",
