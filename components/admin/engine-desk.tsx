      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-[#1b1d1f]/70">
            Original ten stay live. Wave 2 minus Flat 6 (French), AUTOMOBILSPORT (German), and
            EuroStance (Shopify shop, no editorial RSS). Ingest skips non-English items and
            shop/product/collection/cart/merch URLs. {ENGINE_BRANCH} @ {engineCommit().slice(0, 7)}.
          </p>
        </div>
